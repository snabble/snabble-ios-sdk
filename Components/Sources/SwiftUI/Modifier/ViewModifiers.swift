...
public struct PaddingCircle: Shape {
    var percent: CGFloat
...
extension View {
    public func cartInfo() -> some View {
        modifier(CartInfoModifier())
    }
    public func cartInfo(leading: CGFloat) -> some View {
        modifier(CartInfoModifier(leading: leading))
    }
}

extension Image {
    public func cartImageModifier(padding: CGFloat = 0) -> some View {
        self
            .resizable()
            .scaledToFit()
            .padding(padding)
...
extension View {
    public func multiColor(_ color: Color) -> some View {
...
extension View {
    public func doneKeyboard() -> some View {
