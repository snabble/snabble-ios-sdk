...
export interface DangerRunner {
     ...
     */
    runDangerfileEnvironment: (filenames: string[], originalContents: string[] | undefined[] | undefined, environment: any, injectedObjectToExport?: any) => Promise<DangerResults>;
    /**
