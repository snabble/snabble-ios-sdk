...
public final class EANView: UIView {
    ...
    public var barColor: UIColor = Asset.Color.black()

    /// the color to show the barcode's digits. default is black
    public var digitsColor: UIColor = Asset.Color.black()
    ...
    override public func draw(_ rect: CGRect) {
        ...
        let bgColor = self.backgroundColor ?? Asset.Color.systemBackground()
        ...
        if let bits = self.bits {
            ...
            let attrs = [
                ...
                NSAttributedString.Key.foregroundColor: Asset.Color.systemRed()
            ]
    ...
    private func createLabel(width: Int, offset: Int, value: String) -> UILabel {
        ...
        label.backgroundColor = self.backgroundColor ?? Asset.Color.systemBackground()
