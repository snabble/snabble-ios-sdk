...
public final class PaymentMethodListViewControllerOLD: UIViewController {
    ...
    public func addPaymentMethod() {
        ...
        if SnabbleUI.implicitNavigation {
            ...
            let selection = MethodSelectionViewControllerOLD(with: projectId, self.methods, showFromCart: false, self.analyticsDelegate)
...
extension PaymentMethodListViewControllerOLD: UITableViewDelegate, UITableViewDataSource {
