...
public struct InvoiceLoginView: View {
    var model: InvoiceLoginProcessor
    @Bindable private var loginModel: InvoiceLoginModel
...
public struct InvoiceDetailView: View {
    private var loginModel: InvoiceLoginModel
    @Environment(\.presentationMode) var presentationMode
    let domain = "Snabble.Payment.ExternalBilling"
...
public struct InvoiceView: View {
    var loginProcessor: InvoiceLoginProcessor
    private var loginModel: InvoiceLoginModel
