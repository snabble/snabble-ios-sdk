...
* add support for shop-specific price information. This brings another set of breaking changes:
...
* `productsByName` and `productsByScannableCodePrefix` still return products, but without price information (price fields are 0, empty or nil)
