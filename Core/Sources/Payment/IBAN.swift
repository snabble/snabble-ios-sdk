...
public enum IBAN {
    ...
    /// Thread-safety: Computed once from immutable formatCharacters array at static initialization
    nonisolated(unsafe) public static var formatKeys: String = { formatCharacters.reduce("", { "\($0)\($1)" }) }()  // "pbdkKrsX"
